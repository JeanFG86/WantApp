        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateOn = table.Column<DateTime>(type: "datetime without time zone", nullable: false),
                    EditedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    EditedOn = table.Column<DateTime>(type: "datetime without time zone", nullable: false)
                },
                constraints: table =>
                {
